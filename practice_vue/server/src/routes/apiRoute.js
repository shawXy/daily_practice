...
// 获取正在热映的电影
route.get('/api/v2/movie/in_theaters', (req, res) => {
  // 导入本地的数据文件并获取电影数据
...
// 获取即将上映的电影
route.get('/api/v2/movie/coming_soon', (req, res) => {
  // 导入本地的数据文件并获取电影数据
...
// 获取排行 Top250的电影
route.get('/api/v2/movie/top250', (req, res) => {
  // 导入本地的数据文件并获取电影数据
...
// 获取电影详情数据
route.get('/api/v2/movie/subject/:id', (req, res) => {
  // 导入本地的电影详情数据
